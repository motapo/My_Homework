...
!function(e){e.fn.slides=function(n){return n=e.extend({},e.fn.slides.option,n),this.each(function(){function t(){clearInterval(d.data("interval"))}function a(){n.pause?(clearTimeout(d.data("pause")),clearInterval(d.data("interval")),pauseTimeout=setTimeout(function(){clearTimeout(d.data("pause")),playInterval=setInterval(function(){i("next",m)},n.play),d.data("interval",playInterval)},n.pause),d.data("pause",pauseTimeout)):t()}function i(t,a,i){if(!l&&r){switch(l=!0,t){case"next":q=y,I=y+1,I=h===I?0:I,s=2*p,t=2*-p,y=I;break;case"prev":q=y,I=y-1,I=-1===I?h-1:I,s=0,t=0,y=I;break;case"pagination":I=parseInt(i,10),q=e("."+n.paginationClass+" li.current a",d).attr("href").match("[^#/]+$"),I>q?(s=2*p,t=2*-p):(s=0,t=0),y=I}"fade"===a?(n.animationStart(),n.crossfade?f.children(":eq("+I+")",d).css({zIndex:10}).fadeIn(n.fadeSpeed,function(){n.autoHeight?f.animate({height:f.children(":eq("+I+")",d).outerHeight()},n.autoHeightSpeed,function(){f.children(":eq("+q+")",d).css({display:"none",zIndex:0}),f.children(":eq("+I+")",d).css({zIndex:0}),n.animationComplete(I+1),l=!1}):(f.children(":eq("+q+")",d).css({display:"none",zIndex:0}),f.children(":eq("+I+")",d).css({zIndex:0}),n.animationComplete(I+1),l=!1)}):(n.animationStart(),f.children(":eq("+q+")",d).fadeOut(n.fadeSpeed,function(){n.autoHeight?f.animate({height:f.children(":eq("+I+")",d).outerHeight()},n.autoHeightSpeed,function(){f.children(":eq("+I+")",d).fadeIn(n.fadeSpeed)}):f.children(":eq("+I+")",d).fadeIn(n.fadeSpeed,function(){e.browser.msie&&e(this).get(0).style.removeAttribute("filter")}),n.animationComplete(I+1),l=!1}))):(f.children(":eq("+I+")").css({left:s,display:"block"}),n.autoHeight?(n.animationStart(),f.animate({left:t,height:f.children(":eq("+I+")").outerHeight()},n.slideSpeed,function(){f.css({left:-p}),f.children(":eq("+I+")").css({left:p,zIndex:5}),f.children(":eq("+q+")").css({left:p,display:"none",zIndex:0}),n.animationComplete(I+1),l=!1})):(n.animationStart(),f.animate({left:t},n.slideSpeed,function(){f.css({left:-p}),f.children(":eq("+I+")").css({left:p,zIndex:5}),f.children(":eq("+q+")").css({left:p,display:"none",zIndex:0}),n.animationComplete(I+1),l=!1}))),n.pagination&&(e("."+n.paginationClass+" li.current",d).removeClass("current"),e("."+n.paginationClass+" li:eq("+I+")",d).addClass("current"))}}e("."+n.container,e(this)).children().wrapAll('<div class="slides_control"/>');var r,l,o,s,c,d=e(this),f=e(".slides_control",d),h=f.children().size(),p=f.children().outerWidth(),u=f.children().outerHeight(),g=n.start-1,m=n.effect.indexOf(",")<0?n.effect:n.effect.replace(" ","").split(",")[0],v=n.effect.indexOf(",")<0?m:n.effect.replace(" ","").split(",")[1],I=0,q=0,x=0,y=0;if(!(2>h)){if(0>g&&(g=0),g>h&&(g=h-1),n.start&&(y=g),n.randomize&&f.randomize(),e("."+n.container,d).css({overflow:"hidden",position:"relative"}),f.children().css({position:"absolute",top:0,left:f.children().outerWidth(),zIndex:0,display:"none"}),f.css({position:"relative",width:3*p,height:u,left:-p}),e("."+n.container,d).css({display:"block"}),n.autoHeight&&(f.children().css({height:"auto"}),f.animate({height:f.children(":eq("+g+")").outerHeight()},n.autoHeightSpeed)),n.preload&&f.find("img").length){e("."+n.container,d).css({background:"url("+n.preloadImage+") no-repeat 50% 50%"});var C=f.find("img:eq("+g+")").attr("src")+"?"+(new Date).getTime();c="slides_control"!=e("img",d).parent().attr("class")?f.children(":eq(0)")[0].tagName.toLowerCase():f.find("img:eq("+g+")"),f.find("img:eq("+g+")").attr("src",C).load(function(){f.find(c+":eq("+g+")").fadeIn(n.fadeSpeed,function(){e(this).css({zIndex:5}),d.css({background:""}),r=!0})})}else f.children(":eq("+g+")").fadeIn(n.fadeSpeed,function(){r=!0});n.bigTarget&&(f.children().css({cursor:"pointer"}),f.children().click(function(){return i("next",m),!1})),n.hoverPause&&n.play&&(f.children().bind("mouseover",function(){t()}),f.children().bind("mouseleave",function(){a()})),n.generateNextPrev&&(e("."+n.container,d).after('<a href="#" class="'+n.prev+'">Prev</a>'),e("."+n.prev,d).after('<a href="#" class="'+n.next+'">Next</a>')),e("."+n.next,d).click(function(e){e.preventDefault(),n.play&&a(),i("next",m)}),e("."+n.prev,d).click(function(e){e.preventDefault(),n.play&&a(),i("prev",m)}),n.generatePagination?(d.append("<ul class="+n.paginationClass+"></ul>"),f.children().each(function(){e("."+n.paginationClass,d).append('<li><a href="#'+x+'">'+(x+1)+"</a></li>"),x++})):e("."+n.paginationClass+" li a",d).each(function(){e(this).attr("href","#"+x),x++}),e("."+n.paginationClass+" li:eq("+g+")",d).addClass("current"),e("."+n.paginationClass+" li a",d).click(function(){return n.play&&a(),o=e(this).attr("href").match("[^#/]+$"),y!=o&&i("pagination",v,o),!1}),e("a.link",d).click(function(){return n.play&&a(),o=e(this).attr("href").match("[^#/]+$")-1,y!=o&&i("pagination",v,o),!1}),n.play&&(playInterval=setInterval(function(){i("next",m)},n.play),d.data("interval",playInterval))}})},e.fn.slides.option={preload:!1,preloadImage:"/img/loading.gif",container:"slides_container",generateNextPrev:!1,next:"next",prev:"prev",pagination:!0,generatePagination:!0,paginationClass:"pagination",fadeSpeed:350,slideSpeed:350,start:1,effect:"slide",crossfade:!1,randomize:!1,play:0,pause:0,hoverPause:!1,autoHeight:!1,autoHeightSpeed:350,bigTarget:!1,animationStart:function(){},animationComplete:function(){}},e.fn.randomize=function(n){function t(){return Math.round(Math.random())-.5}return e(this).each(function(){var a=e(this),r=a.children(),l=r.length;if(l>1){r.hide();var o=[];for(i=0;i<l;i++)o[o.length]=i;o=o.sort(t),e.each(o,function(e,t){var i=r.eq(t),l=i.clone(!0);l.show().appendTo(a),void 0!==n&&n(i,l),i.remove()})}})}}(jQuery);